...
class XtensorBackend : public TensorBackend {
 public:
  ...
  static XtensorBackend& getInstance();
  ~XtensorBackend() override = default;
  TensorBackendType backendType() const override;

  // No copy or move construction or assignment
  XtensorBackend(XtensorBackend&&) = delete;
  XtensorBackend(const XtensorBackend&) = delete;
  XtensorBackend& operator=(XtensorBackend&&) = delete;
  XtensorBackend& operator=(const XtensorBackend&) = delete;
...
#define FL_XTENSOR_BACKEND_CREATE_FUN_LITERAL_DECL(TYPE)    \
  Tensor fromScalar(TYPE value, const dtype type) override; \
  Tensor full(const Shape& dims, TYPE value, const dtype type) override;
  FL_XTENSOR_BACKEND_CREATE_FUN_LITERAL_DECL(const double&);
  FL_XTENSOR_BACKEND_CREATE_FUN_LITERAL_DECL(const float&);
  FL_XTENSOR_BACKEND_CREATE_FUN_LITERAL_DECL(const int&);
  FL_XTENSOR_BACKEND_CREATE_FUN_LITERAL_DECL(const unsigned&);
  FL_XTENSOR_BACKEND_CREATE_FUN_LITERAL_DECL(const char&);
  FL_XTENSOR_BACKEND_CREATE_FUN_LITERAL_DECL(const unsigned char&);
  FL_XTENSOR_BACKEND_CREATE_FUN_LITERAL_DECL(const long&);
  FL_XTENSOR_BACKEND_CREATE_FUN_LITERAL_DECL(const unsigned long&);
  FL_XTENSOR_BACKEND_CREATE_FUN_LITERAL_DECL(const long long&);
  FL_XTENSOR_BACKEND_CREATE_FUN_LITERAL_DECL(const unsigned long long&);
  FL_XTENSOR_BACKEND_CREATE_FUN_LITERAL_DECL(const bool&);
  FL_XTENSOR_BACKEND_CREATE_FUN_LITERAL_DECL(const short&);
  FL_XTENSOR_BACKEND_CREATE_FUN_LITERAL_DECL(const unsigned short&);
#undef FL_XTENSOR_BACKEND_CREATE_FUN_LITERAL_DECL
  ...
  /************************** Binary Operators ***************************/
#define FL_XTENSOR_BACKEND_BINARY_OP_TYPE_DECL(FUNC, TYPE) \
  Tensor FUNC(const Tensor& a, TYPE rhs) override;         \
  Tensor FUNC(TYPE lhs, const Tensor& a) override;

#define FL_XTENSOR_BACKEND_BINARY_OP_LITERALS_DECL(FUNC)                   \
  FL_XTENSOR_BACKEND_BINARY_OP_TYPE_DECL(FUNC, const bool&);               \
  FL_XTENSOR_BACKEND_BINARY_OP_TYPE_DECL(FUNC, const int&);                \
  FL_XTENSOR_BACKEND_BINARY_OP_TYPE_DECL(FUNC, const unsigned&);           \
  FL_XTENSOR_BACKEND_BINARY_OP_TYPE_DECL(FUNC, const char&);               \
  FL_XTENSOR_BACKEND_BINARY_OP_TYPE_DECL(FUNC, const unsigned char&);      \
  FL_XTENSOR_BACKEND_BINARY_OP_TYPE_DECL(FUNC, const long&);               \
  FL_XTENSOR_BACKEND_BINARY_OP_TYPE_DECL(FUNC, const unsigned long&);      \
  FL_XTENSOR_BACKEND_BINARY_OP_TYPE_DECL(FUNC, const long long&);          \
  FL_XTENSOR_BACKEND_BINARY_OP_TYPE_DECL(FUNC, const unsigned long long&); \
  FL_XTENSOR_BACKEND_BINARY_OP_TYPE_DECL(FUNC, const double&);             \
  FL_XTENSOR_BACKEND_BINARY_OP_TYPE_DECL(FUNC, const float&);              \
  FL_XTENSOR_BACKEND_BINARY_OP_TYPE_DECL(FUNC, const short&);              \
  FL_XTENSOR_BACKEND_BINARY_OP_TYPE_DECL(FUNC, const unsigned short&);

#define FL_XTENSOR_BACKEND_BINARY_OP_DECL(FUNC)               \
  Tensor FUNC(const Tensor& lhs, const Tensor& rhs) override; \
  FL_XTENSOR_BACKEND_BINARY_OP_LITERALS_DECL(FUNC);

  FL_XTENSOR_BACKEND_BINARY_OP_DECL(add);
  FL_XTENSOR_BACKEND_BINARY_OP_DECL(sub);
  FL_XTENSOR_BACKEND_BINARY_OP_DECL(mul);
  FL_XTENSOR_BACKEND_BINARY_OP_DECL(div);
  FL_XTENSOR_BACKEND_BINARY_OP_DECL(eq);
  FL_XTENSOR_BACKEND_BINARY_OP_DECL(neq);
  FL_XTENSOR_BACKEND_BINARY_OP_DECL(lessThan);
  FL_XTENSOR_BACKEND_BINARY_OP_DECL(lessThanEqual);
  FL_XTENSOR_BACKEND_BINARY_OP_DECL(greaterThan);
  FL_XTENSOR_BACKEND_BINARY_OP_DECL(greaterThanEqual);
  FL_XTENSOR_BACKEND_BINARY_OP_DECL(logicalOr);
  FL_XTENSOR_BACKEND_BINARY_OP_DECL(logicalAnd);
  FL_XTENSOR_BACKEND_BINARY_OP_DECL(mod);
  FL_XTENSOR_BACKEND_BINARY_OP_DECL(bitwiseAnd);
  FL_XTENSOR_BACKEND_BINARY_OP_DECL(bitwiseOr);
  FL_XTENSOR_BACKEND_BINARY_OP_DECL(bitwiseXor);
  FL_XTENSOR_BACKEND_BINARY_OP_DECL(lShift);
  FL_XTENSOR_BACKEND_BINARY_OP_DECL(rShift);
#undef FL_XTENSOR_BACKEND_BINARY_OP_DECL
#undef FL_XTENSOR_BACKEND_BINARY_OP_TYPE_DECL
#undef FL_XTENSOR_BACKEND_BINARY_OP_LITERALS_DECL
